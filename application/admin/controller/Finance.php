...
//dump($list->toArray());
        ...
        //
        /*$salaryInArray = $salaryInList->toArray();
        foreach ($salaryInArray['data'] as $key => $salaryin) {
            $sumSalaryin += ($salaryin['salary']+$salaryin['push_salary']);
            $sumScheduleStudent += $salaryin['schedule']['students'];
         }*/
