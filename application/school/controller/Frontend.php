...
class Frontend extends Controller
{
    ...
    public function _initialize()
    {
        ...
        if (input('?param.openid')) {
            $member_id = db('member_openid')->where(['openid' => input('param.openid')])->value('member_id');
            if ($member_id) {
    ...
    public function checkopenid()
    {
        if (cookie('member_id')) {
            ...
            $memberS = new MemberService();
            $memberInfo = $memberS->getMemberInfo(['id' => $member_id]);
            if ($memberInfo) {
                unset($memberInfo['password']);
                cookie('mid', $memberInfo['id']);
                cookie('member_id', $memberInfo['id']);
                ...
                $userinfo = cache('userinfo_' . $userinfo['openid']);
                $member = [
                    'id' => 0,
