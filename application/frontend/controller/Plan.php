...
class Plan extends Base{
    ...
    public function createProject(){
        ...
        // 获取适合阶段
        $ExerciseService = new \app\service\ExerciseService;
        $exerciseTypeList = $ExerciseService->getExerciseType();
        // 训练营信息
        $campInfo = $CampService->getCampInfo(['id'=>$camp_id]);

        $this->assign('campInfo',$campInfo);
        $this->assign('exerciseTypeList',$exerciseTypeList);
        return view('Plan/createProject');
    }
