...
class Frontend extends Controller
{
    ...
    public function _initialize()
    {
        ...
        if (input('?param.openid')) {
            $member = $MemberService->getMemberInfo(['openid' => input('param.openid')]);
            if ($member) {
        ...
        if (input('?param.pid')) {
            $pid = input('param.pid');
            $pmember = $MemberService->getMemberInfo(['id' => $pid]);
            if ($pmember) {
    ...
    public function checkopenid()
    {
        if (cookie('openid')) {
            ...
            $MemberService = new MemberService();
            $memberInfo = $MemberService->getMemberInfo(['openid' => $openid]);
            if ($memberInfo) {
