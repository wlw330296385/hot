...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES ('1', 'admin', '56c1dea092bcdb3c77b072d6ee9914008f8a383d', null, null, '/static/default/avatar.png', null, '1', '0', '0', '50', '1503731861', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.101 Safari/537.36');
...
CREATE TABLE `bill` (
  ...
  `is_pay` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0:未支付|>1:已支付的金额',
  `pay_time` int(10) NOT NULL COMMENT '支付时间',
  `update_time` int(11) NOT NULL,
  `create_time` int(10) NOT NULL,
  `delete_time` int(10) DEFAULT NULL,
  `status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '1:有效|0:无效|2:申请退款',
  PRIMARY KEY (`id`)
...
CREATE TABLE `cert` (
  ...
  `cert_type` tinyint(4) NOT NULL COMMENT '1:身份证;2:学生证;3:资质证书;4:营业执照|5:银行卡',
...
INSERT INTO `coach` VALUES ('9', '张三', '0', '0', '0', '0', '0.0', '1503559375', '1503559375', '1', '0', '', '', '', '', '', '0', '', '', '', '', '', '', '1', '0', null);
INSERT INTO `coach` VALUES ('10', '张三', '0', '1', '0', '0', '0.0', '1503559951', '1503559951', '1', '0', '', '', '', '', '', '0', '', '', '', '', '', '', '1', '0', null);
...
INSERT INTO `grade` VALUES ('2', '小学暑期篮球基础', '1', '幼儿兴趣班（月卡）', '2', '小学暑期篮球基础1班', '1', '大热伟霖篮球训练营', '刘伟霖', '1', '刘伟霖', '1', '刘伟霖', '1', '200.00', '2', '吴丽文', '150.00', '20.00', '2', '周六,周日', '09:30,14:30', '0', '0', '广东省', '深圳市', '罗湖区', '阳光文体中心', '', '1', '滨河小学篮球场', '1', '0.00', '', '1', null, '0', '0');
INSERT INTO `grade` VALUES ('3', '控球后卫进阶暑假班', '2', '幼儿兴趣班（月卡）', '2', '控球后卫进阶暑假1班', '1', '大热伟霖篮球训练营', '刘伟霖', '1', '刘伟霖', '1', '刘伟霖', '1', '300.00', '2,3', '吴丽文,张彩玲', '200.00', '15.00', '1', '周六', '15:00', '0', '0', '广东省', '深圳市', '罗湖区', '阳光文体中心', '', '1', '滨河小学篮球场', '1', '0.00', '', '1', null, '0', '0');
...
-- ----------------------------
INSERT INTO `grade_member` VALUES ('1', '', '1', '小学暑期篮球基础', '1', '1', '大热伟霖篮球训练营', '1', 'weilin', '0', '', 'weilin', '1', '0', '', '3', '1', '0', null);
INSERT INTO `grade_member` VALUES ('3', '3-7岁儿童班', '2', '小学暑期篮球基础', '1', '2', '大热woo训练营', '2', 'woo', '0', '吴光蔚', 'coloring', '1', '0', '', '2', '1', '0', null);
INSERT INTO `grade_member` VALUES ('4', '8-12岁少年班', '1', '控球后卫进阶暑假班', '2', '2', '大热woo训练营', '1', 'woo', '0', '吴光蔚', 'woo', '1', '0', '', '1', '1', '0', null);
INSERT INTO `grade_member` VALUES ('5', '小学暑期篮球基础1班', '2', '小学暑期篮球基础', '1', '1', '大热伟霖篮球训练营', '1', '陈烈准', '2', '陈烈准', '陈烈准', '2', '0', '', '1', '1', '0', null);
INSERT INTO `grade_member` VALUES ('6', '控球后卫进阶暑假1班', '3', '高中综合篮球暑假课程', '3', '1', '大热伟霖篮球训练营', '1', '陈烈候', '3', '陈烈候', '陈烈候', '1', '0', '', '5', '1', '0', null);
INSERT INTO `grade_member` VALUES ('7', '小学暑期篮球基础1班', '2', '控球后卫进阶暑假班', '2', '1', '大热伟霖篮球训练营', '1', '吴光蔚', '4', '吴光蔚', '吴光蔚', '3', '0', '', '5', '1', '0', null);
INSERT INTO `grade_member` VALUES ('8', '高中综合篮球暑假-彩玲班', '4', '高中综合篮球暑假课程', '3', '2', '大热color篮球训练营', '8', '张彩玲', '2', '陈烈准', '陈烈准', '2', '0', '', '5', '1', '0', null);

-- ----------------------------
-- Table structure for `hp_rebate`
-- ----------------------------
DROP TABLE IF EXISTS `hp_rebate`;
CREATE TABLE `hp_rebate` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='hp 返回记录\r\n100%返回,用于消费;';

-- ----------------------------
-- Records of hp_rebate
-- ----------------------------
...
-- Records of member
-- ----------------------------
INSERT INTO `member` VALUES ('1', '', 'weilin', 'WL伟霖', '/static/default/avatar.png', '13410599613', '', '704671079@qq.com', '刘伟霖', '广东省', '深圳市', '', '罗湖区深南东路京基100花园E1栋26C', '1', '192.0', '0.0', '', '44.0', '1993-06-02', '1498842061', '0', '1', '5', '5000', '2', '0', '0', '72.40', 'mysql 插入测试数据', null);
INSERT INTO `member` VALUES ('2', '', 'alice.wu', 'woo', '/static/default/avatar.png', '1358687812', '', 'alicewu@hot-basketball.com', '吴丽文', '广东省', '深圳市', '', '南山区不知道那条村x栋xxx号', '2', '165.0', '80.0', '', '38.0', '1992-12-06', '1498842061', '0', '1', '1', '4500', '0', '0', '0', '448.00', 'mysql 手动插入 测试数据', null);
INSERT INTO `member` VALUES ('3', '', 'coloring', '彩玲', '/static/default/avatar.png', '12334455334', '', '', '张彩玲', '', '', '', '', '0', '0.0', '0.0', '', '0.0', '0000-00-00', '1498842061', '0', '1', '2', '3500', '0', '0', '0', '5.76', '', null);
INSERT INTO `member` VALUES ('4', '', 'legend', '', '/static/default/avatar.png', '1585461234', '', '', '陈烈准', '广东省', '深圳市', '', '', '1', '0.0', '0.0', '', '0.0', '0000-00-00', '1498842061', '0', '1', '2', '3000', '0', '0', '0', '0.00', '测试数据', null);
INSERT INTO `member` VALUES ('5', '', 'ho', '', '/static/default/avatar.png', '1369874512', '', '', '陈烈候', '广东省', '深圳市', '', '', '1', '0.0', '0.0', '', '0.0', '0000-00-00', '1498842061', '0', '1', '3', '2000', '0', '0', '0', '14.64', '测试数据', null);
INSERT INTO `member` VALUES ('6', '', 'will', '', '/static/default/avatar.png', '1594561263', '', '', '吴光蔚', '广东省', '深圳市', '', '', '1', '0.0', '0.0', '', '0.0', '0000-00-00', '1498842061', '0', '1', '4', '1000', '0', '0', '0', '0.00', '', null);
...
CREATE TABLE `rebate` (
  ...
  `delete_time` int(10) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=315 DEFAULT CHARSET=utf8 COMMENT='组织收入明细表';
...
CREATE TABLE `salary_in` (
  ...
  `delete_time` int(10) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=255 DEFAULT CHARSET=utf8 COMMENT='系统发放教练佣金';

-- ----------------------------
-- Records of salary_in
-- ----------------------------
INSERT INTO `salary_in` VALUES ('234', '89.60', '2', '2', 'alice.wu', '1', '1', '1', '小学暑期篮球基础', '2', '小学暑期篮球基础1班', '0.0', '1', '大热伟霖篮球训练营', '1503741596', '1', '1', '4', '1503741596', null);
INSERT INTO `salary_in` VALUES ('235', '12.80', '1', '1', 'weilin', '5', '1', '1', '小学暑期篮球基础', '2', '小学暑期篮球基础1班', '0.0', '1', '大热伟霖篮球训练营', '1503741596', '1', '1', '1', '1503741596', null);
INSERT INTO `salary_in` VALUES ('236', '0.00', '2', '2', 'alice.wu', '1', '1', '1', '小学暑期篮球基础', '2', '小学暑期篮球基础1班', '0.0', '1', '大热伟霖篮球训练营', '1503741596', '1', '1', '4', '1503741596', null);
INSERT INTO `salary_in` VALUES ('237', '0.00', '1', '1', 'weilin', '5', '1', '1', '小学暑期篮球基础', '2', '小学暑期篮球基础1班', '0.0', '1', '大热伟霖篮球训练营', '1503741596', '1', '1', '1', '1503741596', null);
INSERT INTO `salary_in` VALUES ('238', '0.00', '2', '2', 'alice.wu', '1', '1', '1', '小学暑期篮球基础', '2', '小学暑期篮球基础1班', '0.0', '1', '大热伟霖篮球训练营', '1503741596', '1', '1', '4', '1503741596', null);
INSERT INTO `salary_in` VALUES ('239', '0.00', '1', '1', 'weilin', '5', '1', '1', '小学暑期篮球基础', '2', '小学暑期篮球基础1班', '0.0', '1', '大热伟霖篮球训练营', '1503741596', '1', '1', '1', '1503741596', null);
INSERT INTO `salary_in` VALUES ('240', '0.00', '2', '2', 'alice.wu', '1', '1', '1', '小学暑期篮球基础', '2', '小学暑期篮球基础1班', '0.0', '1', '大热伟霖篮球训练营', '1503741596', '1', '1', '4', '1503741596', null);
INSERT INTO `salary_in` VALUES ('241', '0.00', '1', '1', 'weilin', '5', '1', '1', '小学暑期篮球基础', '2', '小学暑期篮球基础1班', '0.0', '1', '大热伟霖篮球训练营', '1503741596', '1', '1', '1', '1503741596', null);
INSERT INTO `salary_in` VALUES ('242', '0.00', '2', '2', 'alice.wu', '1', '1', '1', '小学暑期篮球基础', '2', '小学暑期篮球基础1班', '0.0', '1', '大热伟霖篮球训练营', '1503741596', '1', '1', '4', '1503741596', null);
INSERT INTO `salary_in` VALUES ('243', '0.00', '1', '1', 'weilin', '5', '1', '1', '小学暑期篮球基础', '2', '小学暑期篮球基础1班', '0.0', '1', '大热伟霖篮球训练营', '1503741596', '1', '1', '1', '1503741596', null);
INSERT INTO `salary_in` VALUES ('244', '0.00', '2', '2', 'alice.wu', '1', '1', '1', '小学暑期篮球基础', '2', '小学暑期篮球基础1班', '0.0', '1', '大热伟霖篮球训练营', '1503741596', '1', '1', '4', '1503741596', null);
INSERT INTO `salary_in` VALUES ('245', '0.00', '1', '1', 'weilin', '5', '1', '1', '小学暑期篮球基础', '2', '小学暑期篮球基础1班', '0.0', '1', '大热伟霖篮球训练营', '1503741596', '1', '1', '1', '1503741596', null);
INSERT INTO `salary_in` VALUES ('246', '0.00', '2', '2', 'alice.wu', '1', '1', '2', '控球后卫进阶暑假班', '3', '控球后卫进阶暑假1班', '0.0', '1', '大热伟霖篮球训练营', '1503741596', '1', '1', '4', '1503741596', null);
INSERT INTO `salary_in` VALUES ('247', '0.00', '3', '3', 'coloring', '2', '1', '2', '控球后卫进阶暑假班', '3', '控球后卫进阶暑假1班', '0.0', '1', '大热伟霖篮球训练营', '1503741596', '1', '1', '4', '1503741596', null);
INSERT INTO `salary_in` VALUES ('248', '0.00', '1', '1', 'weilin', '5', '1', '2', '控球后卫进阶暑假班', '3', '控球后卫进阶暑假1班', '0.0', '1', '大热伟霖篮球训练营', '1503741596', '1', '1', '1', '1503741596', null);
INSERT INTO `salary_in` VALUES ('249', '0.00', '2', '2', 'alice.wu', '1', '1', '2', '控球后卫进阶暑假班', '3', '控球后卫进阶暑假1班', '0.0', '1', '大热伟霖篮球训练营', '1503741596', '1', '1', '4', '1503741596', null);
INSERT INTO `salary_in` VALUES ('250', '0.00', '3', '3', 'coloring', '2', '1', '2', '控球后卫进阶暑假班', '3', '控球后卫进阶暑假1班', '0.0', '1', '大热伟霖篮球训练营', '1503741596', '1', '1', '4', '1503741596', null);
INSERT INTO `salary_in` VALUES ('251', '0.00', '1', '1', 'weilin', '5', '1', '2', '控球后卫进阶暑假班', '3', '控球后卫进阶暑假1班', '0.0', '1', '大热伟霖篮球训练营', '1503741596', '1', '1', '1', '1503741596', null);
INSERT INTO `salary_in` VALUES ('252', '0.00', '2', '2', 'alice.wu', '1', '1', '2', '控球后卫进阶暑假班', '3', '控球后卫进阶暑假1班', '0.0', '1', '大热伟霖篮球训练营', '1503741596', '1', '1', '4', '1503741596', null);
INSERT INTO `salary_in` VALUES ('253', '0.00', '3', '3', 'coloring', '2', '1', '2', '控球后卫进阶暑假班', '3', '控球后卫进阶暑假1班', '0.0', '1', '大热伟霖篮球训练营', '1503741596', '1', '1', '4', '1503741596', null);
INSERT INTO `salary_in` VALUES ('254', '0.00', '1', '1', 'weilin', '5', '1', '2', '控球后卫进阶暑假班', '3', '控球后卫进阶暑假1班', '0.0', '1', '大热伟霖篮球训练营', '1503741596', '1', '1', '1', '1503741596', null);
...
-- Records of schedule
-- ----------------------------
INSERT INTO `schedule` VALUES ('1', '1', '大热伟霖篮球训练营', '小学暑期篮球基础', '1', '小学暑期篮球基础1班', '2', '7', '小学 - 基础班（7-9岁）', '刘伟霖', '1', '刘伟霖', '1', '2', '陈烈准,吴光蔚', '7', '吴丽文', '100.00', '80.00', '30.00', '', '0', '2017-08-23', '0', '', '1501291800', '', '广东省', '深圳市', '罗湖区', '0', '滨河小学篮球场', '', '0.00', '14.0', '', '', '', '1', '1503450300', null);
INSERT INTO `schedule` VALUES ('2', '1', '大热伟霖篮球训练营', '小学暑期篮球基础', '1', '小学暑期篮球基础1班', '2', '7', '小学 - 基础班（7-9岁）', '刘伟霖', '1', '刘伟霖', '1', '2', '陈烈准,吴光蔚', '7', '吴丽文', '0.00', '0.00', '0.00', '', '0', '2017-08-23', '0', '', '1501378200', '', '广东省', '深圳市', '罗湖区', '0', '滨河小学篮球场', '', '0.00', '0.0', '', '', '', '1', '1503450300', null);
INSERT INTO `schedule` VALUES ('3', '1', '大热伟霖篮球训练营', '小学暑期篮球基础', '1', '小学暑期篮球基础1班', '2', '7', '小学 - 基础班（7-9岁）', '刘伟霖', '1', '刘伟霖', '1', '2', '陈烈准,吴光蔚', '7', '吴丽文', '0.00', '0.00', '0.00', '', '0', '2017-08-23', '0', '', '1501896600', '', '广东省', '深圳市', '罗湖区', '0', '滨河小学篮球场', '', '0.00', '0.0', '', '', '', '1', '1503450300', null);
INSERT INTO `schedule` VALUES ('4', '1', '大热伟霖篮球训练营', '小学暑期篮球基础', '1', '小学暑期篮球基础1班', '2', '7', '小学 - 基础班（7-9岁）', '刘伟霖', '1', '刘伟霖', '1', '2', '陈烈准,吴光蔚', '7', '吴丽文', '0.00', '0.00', '0.00', '', '0', '2017-08-23', '0', '', '1501983000', '', '广东省', '深圳市', '罗湖区', '0', '滨河小学篮球场', '', '0.00', '0.0', '', '', '', '1', '1503450300', null);
INSERT INTO `schedule` VALUES ('5', '1', '大热伟霖篮球训练营', '小学暑期篮球基础', '1', '小学暑期篮球基础1班', '2', '7', '小学 - 基础班（7-9岁）', '刘伟霖', '1', '刘伟霖', '1', '2', '陈烈准,吴光蔚', '7', '吴丽文', '0.00', '0.00', '0.00', '', '0', '2017-08-23', '0', '', '1502501400', '', '广东省', '深圳市', '罗湖区', '0', '滨河小学篮球场', '', '0.00', '0.0', '', '', '', '1', '1503450300', null);
INSERT INTO `schedule` VALUES ('6', '1', '大热伟霖篮球训练营', '小学暑期篮球基础', '1', '小学暑期篮球基础1班', '2', '7', '小学 - 基础班（7-9岁）', '刘伟霖', '1', '刘伟霖', '1', '2', '陈烈准,吴光蔚', '7', '吴丽文', '0.00', '0.00', '0.00', '', '0', '2017-08-23', '0', '', '1502587800', '', '广东省', '深圳市', '罗湖区', '0', '滨河小学篮球场', '', '0.00', '0.0', '', '', '', '1', '1503450300', null);
INSERT INTO `schedule` VALUES ('7', '1', '大热伟霖篮球训练营', '控球后卫进阶暑假班', '2', '控球后卫进阶暑假1班', '3', '7', '小学 - 基础班（7-9岁）', '刘伟霖', '1', '刘伟霖', '1', '2', '陈烈准,吴光蔚', '7,8', '吴丽文,张彩玲', '0.00', '0.00', '0.00', '', '0', '2017-08-23', '0', '', '1501311600', '', '广东省', '深圳市', '罗湖区', '0', '滨河小学篮球场', '', '0.00', '0.0', '', '', '', '1', '1503450300', null);
INSERT INTO `schedule` VALUES ('8', '1', '大热伟霖篮球训练营', '控球后卫进阶暑假班', '2', '控球后卫进阶暑假1班', '3', '7', '小学 - 基础班（7-9岁）', '刘伟霖', '1', '刘伟霖', '1', '2', '陈烈准,吴光蔚', '7,8', '吴丽文,张彩玲', '0.00', '0.00', '0.00', '', '0', '2017-08-23', '0', '', '1501916400', '', '广东省', '深圳市', '罗湖区', '0', '滨河小学篮球场', '', '0.00', '0.0', '', '', '', '1', '1503450300', null);
INSERT INTO `schedule` VALUES ('9', '1', '大热伟霖篮球训练营', '控球后卫进阶暑假班', '2', '控球后卫进阶暑假1班', '3', '7', '小学 - 基础班（7-9岁）', '刘伟霖', '1', '刘伟霖', '1', '2', '陈烈准,吴光蔚', '7,8', '吴丽文,张彩玲', '0.00', '0.00', '0.00', '', '0', '2017-08-23', '0', '', '1502521200', '', '广东省', '深圳市', '罗湖区', '0', '滨河小学篮球场', '', '0.00', '0.0', '', '', '', '1', '1503450300', null);
