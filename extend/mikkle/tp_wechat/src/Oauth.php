...
use mikkle\tp_wechat\support\Log;
...
class Oauth extends WechatBase
{
    ...
    public function getOauthAccessToken()
    {
        ...
        $result = Curl::curlGet(self::API_BASE_URL_PREFIX . self::OAUTH_TOKEN_URL . "appid={$this->appId}&secret={$this->appsecret}&code={$code}&grant_type=authorization_code");
        if ($result) {
